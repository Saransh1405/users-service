...
const (
	...
	InvalidStartDateMessage                = "errors.InvalidStartDate"
	InvalidEndDateMessage                  = "errors.InvalidEndDate"
	EndDateBeforeStartDateMessage          = "errors.EndDateBeforeStartDate"
	MaxParticipantsLessThanMinParticipants = "errors.MaxParticipantsLessThanMinParticipants"

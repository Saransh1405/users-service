...
Go Lang API's for the Cordelia Cruise App
...
- [ ] Read redis creds from config file
- [ ] Hashicorp Vault
  - [ ] Install vault library
  - [ ] Generate, Store and read api key and hash through vault
- [ ]
...
```shell
git clone git@github.com:users-service/go-example-project.git
